...
public class Recipe {
	 ...
	 * @param fileName 	   - File name for recipe's image
	...
	public Recipe(String name, MealType mealType, int portions, ArrayList<Measurement> measurements,
			ArrayList<String> method, String fileName) throws Exception {
		this.ID = nextID++;
	...
	public Recipe(String name, MealType mealtype, int portions, Measurement[] measurementsArr, String[] methodArr, String fileName)
			throws Exception {
		this.ID = nextID++;
		String error = ""; // Any errors made when constructing added to this string
		try {
	...
	/**
	 * Returns recipe image file name
	 ...
	 * @return - path to recipe's image file
	 */
	public String getImgPath() {
		return "/images/Recipes/"+this.fileName;
	}
